...
public class OrderService {
    ...
    public com.example.foodNow.dto.OrderResponse createOrder(com.example.foodNow.dto.OrderRequest request) {
        ...
        order.setDeliveryAddress(
                request.getDeliveryAddress() != null ? request.getDeliveryAddress() : "Default Address");
        ...
        for (com.example.foodNow.dto.OrderItemRequest itemRequest : request.getItems()) {
            com.example.foodNow.model.MenuItem menuItem = menuItemRepository.findById(itemRequest.getMenuItemId())
            ...
            orderItem
                    .setSubtotal(menuItem.getPrice().multiply(java.math.BigDecimal.valueOf(itemRequest.getQuantity())));
    ...
    private com.example.foodNow.dto.OrderItemResponse mapToOrderItemResponse(
        ...
        if (orderItem.getSelectedOptions() != null && !orderItem.getSelectedOptions().isEmpty()) {
            java.util.List<com.example.foodNow.dto.SelectedOptionResponse> options = orderItem.getSelectedOptions()
                    .stream()
